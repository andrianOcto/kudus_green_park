...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2015 at 12:13 PM
...
CREATE TABLE IF NOT EXISTS `m_info_rth` (
  ...
  `tahun_rencana` int(11) DEFAULT NULL,
  `path_rencana` varchar(255) DEFAULT NULL,
  `tahun_realisasi` int(11) DEFAULT NULL,
  `path_realisasi` varchar(255) DEFAULT NULL
...
INSERT INTO `m_info_rth` (`id_rth`, `kecamatan`, `desa`, `status_lahan`, `jenis`, `luas`, `jenis_tanaman`, `fungsi`, `detail_peta`, `pengelola`, `nama`, `alamat`, `location`, `tahun_rencana`, `path_rencana`, `tahun_realisasi`, `path_realisasi`) VALUES
('K3.DK1.J7.0001', 'K3', 'DK18', 2, 'J7', 'Persegi/ 1,06 ha', 'Angsana, mahoni', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan Desa Getas Pejaten', 'Getas Pejaten\nKecamatan Jati', '13123123', 2015, '1447498328_ufAvkzcthyEY.PNG', 2015, '1447498328_LuILYwx6u7Hf.png'),
('K3.DK1.J7.0003', 'K3', 'DK14', 2, 'J7', 'Persegi/0,92 ha', 'Angsana, talok', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan Desa Loram Kulon', 'Desa Loram Kulon', '', NULL, NULL, 2016, '1447497471_3TsjqLXQasIG.PNG'),
('K3.DK1.J7.0004', 'K3', 'DK19', 4, 'J7', 'Persegi/0,86 ha', 'Waru', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan Desa Megawon', 'Desa Megawon Kec. Jati', '', NULL, NULL, NULL, NULL),
('K4.DK1.J7.0001', 'K4', '0', 2, 'J7', 'Persegi / 1,49 ha', 'Angsana, Glodokan', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan desa depan SMP 1', 'Kecamatan Kaliwungu', '', NULL, NULL, NULL, NULL),
('K4.DK1.J7.0002', 'K4', 'DK23', 3, 'J7', 'Persegi / 1,24', 'Angsana, Glodokan, mahoni', 'Lapangan Olahraga', '', 'Sekolah', 'Lapangan Prambatan', 'Jalan Jepara  Prambatan Lor Kecamatan Kaliwungu (depan PTP)', '', NULL, NULL, NULL, NULL),
('K4.DK1.J7.0003', 'K4', 'DK21', 2, 'J7', 'Persegi / 0,62 ha', 'Angsana, Glodokan, mahoni', 'lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan Desa Mijen', 'Kecamatan Kaliwungu', '', NULL, NULL, NULL, NULL),
('K4.DK25.J1.0001', 'K4', 'DK25', 1, 'J1', '3,8 ha', 'Relatif kurang tanaman peneduh', 'Parkir wisata, sector informal, dan lahan kosong', '', 'Dinas Perhubungan', 'Taman dan lapangan parkir Wisata dan Lapangan', 'taman rumah susun Bakalan Krapyak Kec. Kaliwungu', '', NULL, NULL, NULL, NULL),
('K6.DK1.J7.0001', 'K11', 'DK52', 2, 'J7', 'Persegi / 0,78 ha', 'Angsana, Glodokan, mahoni', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan desa depan kantor Kecamatan', 'Kecamatan Mejobo', '', NULL, NULL, NULL, NULL),
('K6.DK52.J2.0001', 'K11', 'DK52', 1, 'J2', '0,44 ha', 'angsana, mahoni,', 'Penghubung jalur Kecamatan, peneduh pejalan kaki', '', 'Pemda', 'Koridor jalan depan samsat Mejobo', 'Jalan menuju samsat', '', NULL, NULL, NULL, NULL),
('K7.DK1.J7.0001', 'K7', 'DK35', 1, 'J7', 'Persegi / 1 ha', 'Angsana', 'Lapangan interaksi sosial tingkat desa, kegiatan mix use', '', '-', 'Lapangan Bekas Lokasi Pasar', 'Kecamatan Jekulo', '', NULL, NULL, NULL, NULL),
('K7.DK1.J7.0002', 'K7', 'DK36', 2, 'J7', 'Persegi / 0,86', 'Angsana, Glodokan, mahoni', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan desa sebelah SPBU', 'sebelah SPBU Desa Hadipolo\nKecamatan Jekulo', '', NULL, NULL, NULL, NULL),
...
('K7.DK1.J7.0004', 'K7', 'DK38', 2, 'J7', 'Persegi/ 1,03', 'Angsana, mahoni', 'Lapangan Olahraga', '', 'Pemerintah Desa', 'Lapangan desa Pladen', 'Desa Pladen Kecamatan Jekulo', '', NULL, NULL, NULL, NULL),
('K7.DK1.J7.0005', 'K7', 'DK37', 2, 'J7', 'Persegi / 0,86 ha', 'Angsana, Glodokan, mahoni', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan desa Sidomulyo', 'Desa Tanjungrejo Kecamatan Jekulo', '', NULL, NULL, NULL, NULL),
('K7.DK35.J1.0001', 'K7', 'DK35', 1, 'J1', '1 ha', 'Angsana', 'Lapangan interaksi sosial tingkat desa, kegiatan mix use', '', '-', 'Lapangan / taman bekas lokasi Pasar', 'Pasar Jekulo dan Kantor PDAM Kec. Jekulo', '', NULL, NULL, NULL, NULL),
('K7.DK35.J1.0002', 'K7', 'DK34', 1, 'J1', '1,88 ha', 'Angsana, glodokan', 'Area  pemberhentian truk antar kota', '', 'Dinas Perhubungan', 'Pangkalan truk Klaling', 'Klaling Kecamatan Jekulo', '', NULL, NULL, NULL, NULL),
('K8.DK1.J7.0001', 'K8', 'DK39', 2, 'J7', 'Persegi/ 1,28 ha', 'Angsana, Glodokan, mahoni', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan desa Cendono', 'Desa Cendono Kecamatan Dawe', '', NULL, NULL, NULL, NULL),
('K8.DK1.J7.0002', 'K8', 'DK42', 2, 'J7', 'Persegi/ 1,2 ha', 'Angsana, Glodokan, mahoni', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan desa Lau', 'Desa Lau Kecamatan Dawe', '', NULL, NULL, NULL, NULL),
('K8.DK1.J7.0003', 'K8', 'DK40', 2, 'J7', 'Persegi/ 1,03 ha', 'Angsana, Glodokan, mahoni', 'Lapangan olahraga', '', 'Pemerintah Desa', 'Lapangan Piji', 'Desa Piji Kecamatan Dawe', '', NULL, NULL, NULL, NULL);
...
(26, 2, 'coba', 'coba buat testimoni', '1446650781_utihKKVSi7x7.jpg', '2015-11-04 15:26:22', '0000-00-00 00:00:00');
...
(136, 'K3.DK1.J7.0001', '1447496284_IWSB2ge1GOC0.png', '2015-11-14 10:18:04');
...
('K6.DK1', 'K6', 'Megawon', '2015-11-13 08:10:01', '0000-00-00 00:00:00');
...
('J1', 'Taman Kota', '2015-10-22 18:17:11', '0000-00-00 00:00:00'),
...
(26, 'Deny', 'deny', '$2y$10$wr8bef8qXujEMT0eBGIKzuqf0Xp5nFFbWOdjFIQoX3CshuFXvBb/a', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `s_video`
--

CREATE TABLE IF NOT EXISTS `s_video` (
...
--
-- Dumping data for table `s_video`
--

INSERT INTO `s_video` (`url`, `created`, `updated`) VALUES
('https://www.youtube.com/embed/qS8-XInj_qg', '2015-10-22 18:57:20', '2015-10-22 18:28:52');
...
--
ALTER TABLE `m_photo`
MODIFY `idphoto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=137;
--
