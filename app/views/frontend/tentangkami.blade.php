...
<div class="container"  style="padding-top:50px; padding-bottom:70px">
    <div class="row">
        ...
        <img src="{{ URL::asset('images/banner_bupati_kudus.png') }}" style="margin-top:10px; width:100%">
